...
public abstract class JakartaRSServerContainerInstantiator extends JakartaRSContainerInstantiator {

	public static final String JAKARTARS_SERVER_CONFIG = "ecf.jakartars.server";
	...
	public JakartaRSServerContainerInstantiator(String serverConfigTypeName) {
		super(serverConfigTypeName);
	}

	public JakartaRSServerContainerInstantiator(String serverConfigTypeName, String clientConfigTypeName) {
	...
	protected String getSystemPathPrefix(Map<String, ?> params, String configName) {
		return getSystemProperty(configName, URL_PATH_PREFIX_PROP,
				getSystemProperty(JAKARTARS_SERVER_CONFIG, URL_PATH_PREFIX_PROP, URL_PATH_PREFIX_DEFAULT));
	}
